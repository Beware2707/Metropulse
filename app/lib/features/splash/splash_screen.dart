  ...
  Widget build(BuildContext context) {
    ...
    final logo = Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: AppColors.brandViolet.withValues(alpha: 0.45), blurRadius: 40, offset: const Offset(0, 16)),
        ],
      ),
          ...
          child: Column(
            ...
            children: reduceMotion
                ...
                : [
                    ...
                    FadeTransition(
                      opacity: CurvedAnimation(
                        parent: _controller, curve: const Interval(0.6, 1.0, curve: Curves.easeOut),
                      ),
                      child: tagline,
                    ),
                    const SizedBox(height: 40),
                    FadeTransition(
                      opacity: CurvedAnimation(
                        parent: _controller, curve: const Interval(0.7, 1.0, curve: Curves.easeOut),
                      ),
                      child: loadingBar,
                    ),
                  ],
...
class _PulseBarState extends State<_PulseBar> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final sweep = DecoratedBox(decoration: BoxDecoration(gradient: AppColors.heroGradientFor()));
    return ClipRRect(
        ...
        child: Stack(
          children: [
            ...
            if (MediaQuery.of(context).disableAnimations)
              FractionallySizedBox(widthFactor: 1.0, child: sweep)
            else
              AnimatedBuilder(
