...
from metropulse.api.v1.fare_advisor import router as fare_advisor_router
from metropulse.api.v1.favourites import router as favourites_router
from metropulse.api.v1.feedback import router as feedback_router
...
from metropulse.api.v1.journey_share import router as journey_share_router
from metropulse.api.v1.journey_tools import router as journey_tools_router
...
from metropulse.api.v1.park_and_ride import router as park_and_ride_router
...
router.include_router(journey_share_router)
router.include_router(journey_plan_router)
router.include_router(journey_tools_router)
router.include_router(park_and_ride_router)
router.include_router(fare_advisor_router)
